...
#define PLL_CLOCK       			                    FREQ_48MHZ  //FREQ_50MHZ
...
#define FLAG_MISC_TIMER_PERIOD_250MS                    (flag_MISC_CTL.bit3)
...
void TMR3_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(TIMER3) == 1)
    {
		...
		if ((get_tick() % 250) == 0)
		{
            FLAG_MISC_TIMER_PERIOD_250MS = 1;
		}        
...
void loop(void)
{
    ...
    if (FLAG_MISC_TIMER_PERIOD_250MS)//(is_flag_set(flag_timer_period_1000ms))
    {
        FLAG_MISC_TIMER_PERIOD_250MS = 0;//set_flag(flag_timer_period_1000ms ,DISABLE);
